...
version = (findProperty("shardVersion") as? String)?.takeIf { it.isNotBlank() } ?: "1.1"
...
bukkit {
  ...
  permissions {
    ...
    register("shard.monitor.config") {
      description = "Allows writing the bundled monitor.yml reference file"
      default = Permission.Default.FALSE
    }
